...
tagList(
  ...
  div(
    ...
    conditionalPanel(
      ...
      h5("Dispersion Plot", style = "margin-top: 30px;"),

      # Barcode Granularity Settings ----
      # The barcode is the only visualization. Its granularity controls how the
      # occurrences are laid out (whole corpus, by meta group, or by text).
      conditionalPanel(
        ...
        div(
          ...
          radioButtons(ns("barcode_granularity"),
                      ...
                      selected = "corpus"),
          helpText(style = "margin-top: -6px; font-size: 12px;",
                   "Display grouping only - independent of the DP calculation above."),

          # Plain-language explanation of what the chosen layout shows.
          uiOutput(ns("barcode_layout_note")),
